...
public class DoubleTestCase extends WiseTest {
    @Drone
    ...
    public void doubleTest() {
        ...
        checkStepTwoData("191.919", false);
        checkMessageDisclosurePanel("<arg0>191.919</arg0>");
        gotoStepThree();

        // page: step 3
        confirmPageLoaded(PropUtils.get("page.invoke"));
        checkStepThreeData(1);
        checkMessageDisclosurePanel("<return>191.919</return>");
    }
}
